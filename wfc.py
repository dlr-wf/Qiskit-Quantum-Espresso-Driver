...
class Wfc:
    def __init__(
        ...
        # print("reciprocal_cell from xml: ", b1, b2, b3)
        # print("reciprocal_cell from dat/hdf5: ", self.b1, self.b2, self.b3)
        # print(f"self.cell_volume_reciprocal: {self.cell_volume_reciprocal}")
        ...
        ), f"Lattice vectors in {output_xml} do not match the given reciprocal lattice vectors b1, b2, b3 (possibly from dat/hdf5 file)"
